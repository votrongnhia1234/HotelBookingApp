...
(1, 1, NULL, 5, 'Khách sạn sạch sẽ, vị trí trung tâm thuận tiện.'),
(2, 1, NULL, 4, 'Phòng đẹp nhưng bữa sáng hơi ít món.'),
(3, 2, NULL, 5, 'Khách sạn ở Hà Nội tuyệt vời, nhân viên thân thiện.'),
(4, 3, NULL, 4, 'Biển đẹp, hồ bơi sạch, đồ ăn ngon.'),
(5, 4, NULL, 5, 'Chuỗi khách sạn Mường Thanh vẫn luôn chất lượng.'),
(6, 5, NULL, 4, 'Phòng rộng, hiện đại, nhân viên nhiệt tình.'),
(7, 6, NULL, 5, 'Không gian nghỉ dưỡng tuyệt vời, đồ ăn ngon.'),
(8, 7, NULL, 4, 'Hồ Tây yên tĩnh, khách sạn đẹp.'),
(9, 8, NULL, 5, 'View núi cực đẹp, không khí trong lành.'),
(10, 9, NULL, 4, 'Khách sạn trung tâm, tiện di chuyển.'),
(1, 10, NULL, 5, 'Phòng cao cấp, view đẹp, nhân viên chuyên nghiệp.'),
(2, 11, NULL, 4, 'Rex Hotel nổi tiếng, dịch vụ tốt nhưng giá hơi cao.'),
(3, 16, NULL, 5, 'Hội An Ancient House rất đáng tiền, gần phố cổ.'),
(4, 17, NULL, 4, 'Khách sạn trung tâm Pleiku, yên tĩnh và sạch sẽ.'),
(5, 18, NULL, 5, 'View sông Bạc Liêu đẹp, nhân viên chu đáo.'),
(6, 19, NULL, 4, 'Không gian yên tĩnh, gần trung tâm Long An.'),
(7, 20, NULL, 4, 'Phòng sạch sẽ, bữa sáng ổn, nhân viên nhiệt tình.'),
(8, 21, NULL, 5, 'Khách sạn gần sông Lam, view đẹp, đồ ăn ngon.'),
(9, 22, NULL, 4, 'Phòng hiện đại, đầy đủ tiện nghi.'),
(10, 23, NULL, 5, 'Khách sạn Rạch Giá đẹp, đồ ăn ngon.'),
(1, 24, NULL, 5, 'Khu nghỉ dưỡng Kon Tum rất trong lành, thoải mái.'),
(2, 25, NULL, 4, 'Khách sạn trung tâm Lạng Sơn, giá hợp lý.'),
(3, 26, NULL, 4, 'Phòng đẹp, gần Đại học Thái Nguyên, tiện lợi.'),
(4, 27, NULL, 5, 'Heritage Hotel cổ điển, dịch vụ chuyên nghiệp.'),
(5, 28, NULL, 4, 'Gần núi Bà Đen, phong cảnh tuyệt đẹp.'),
(6, 29, NULL, 5, 'Resort biển Phan Thiết rất đáng trải nghiệm.'),
(7, 30, NULL, 4, 'Giá hợp lý, phòng sạch sẽ, trung tâm Cà Mau.'),
(8, 31, NULL, 4, 'Khách sạn Lào Cai hiện đại, nhân viên thân thiện.'),
(9, 6, NULL, 5, 'Dịch vụ tuyệt vời, đáng để quay lại.'),
(10, 9, NULL, 4, 'Phòng thoải mái, giá phù hợp.'),
(3, 11, NULL, 5, 'Rex Hotel đúng chuẩn 5 sao, nhân viên chuyên nghiệp.'),
(8, 29, NULL, 5, 'View biển Mũi Né tuyệt vời, phòng sạch đẹp.'),
(7, 21, NULL, 4, 'Không gian yên bình, thích hợp nghỉ dưỡng.'),
(2, 19, NULL, 4, 'Khách sạn Long An nhỏ nhưng yên tĩnh.'),
(9, 30, NULL, 5, 'Phòng rộng, giá phải chăng, gần trung tâm.'),
(5, 25, NULL, 3, 'Cơ sở vật chất ổn, nhưng cách âm chưa tốt.'),
(6, 31, NULL, 5, 'Khách sạn gần ga, thuận tiện đi lại.'),
(1, 17, NULL, 4, 'Giá hợp lý, dịch vụ tốt.'),
(4, 28, NULL, 4, 'Phong cảnh núi Bà Đen rất đẹp, nhân viên thân thiện.'),
(8, 27, NULL, 5, 'Nam Định Heritage mang phong cách châu Âu cổ điển.'),
(9, 16, NULL, 5, 'Hội An Ancient House đẹp và yên tĩnh.'),
(10, 5, NULL, 4, 'Grand Palace hiện đại, gần trung tâm.'),
(3, 4, NULL, 4, 'Mường Thanh luôn giữ chất lượng ổn định.'),
(2, 2, NULL, 5, 'Phòng Hà Nội đẹp, nhân viên thân thiện.'),
(1, 3, NULL, 5, 'Resort biển Nha Trang rất tuyệt vời.'),
(6, 7, NULL, 5, 'Lakeside Hotel gần hồ, không gian thoáng mát.'),
(5, 8, NULL, 5, 'Mountain View đẹp, đáng trải nghiệm.'),
(4, 20, NULL, 4, 'Khách sạn Thanh Hóa trung tâm, giá hợp lý.'),
(7, 22, NULL, 5, 'Bình Dương Sky View có rooftop đẹp.'),
(9, 23, NULL, 4, 'Phòng sạch sẽ, gần trung tâm Rạch Giá.'),
(10, 26, NULL, 4, 'Thái Nguyên Galaxy yên tĩnh, thoải mái.');
